      ...
      <div class="row">
        <div class="nav-align-top">
          <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
            <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="ri-coupon-line me-1_5"></i> Vouchers List</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('myVoucher')}}"><i class="ri-coupon-3-line me-1_5"></i> My Vouchers</a></li>
          </ul>
        </div>
        <div>
            ...
            @foreach ($voucher as $item)
              <div class="col">
                <div class="card h-100 text-center border-success">
                  <form action="{{ route('vouchers-add') }}" method="post" class="card-body d-flex flex-column justify-content-between">
                    @csrf
                    ...
                    @else
                      <button class="btn btn-success mt-3 btnClaim" style="width: 150px; margin: 0 auto;">Claim</button>
                    @endif
                  </form>
                </div>
              </div>
